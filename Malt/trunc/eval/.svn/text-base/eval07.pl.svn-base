#!/usr/bin/env perl
# $Id: eval07.pl,v 1.1 2007/08/15 08:41:24 jni Exp $
...
my ($usage) = <<EOT
  ...
  Optional parameters:
     ...
     -p : punctuation: do not score punctuation (default is to score on it)
...
if (defined $opt_v)
{
    my $id = '$Id: eval07.pl,v 1.1 2007/08/15 08:41:24 jni Exp $';
    my @parts = split ' ',$id;
