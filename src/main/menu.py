...
class ApplicationCLI:
    ...
    @staticmethod
    def __parse_args_train(parser: ArgumentParser) -> ArgumentParser:
        choices = [
            "mst",
            "malt"
        ]
    ...
    @staticmethod
    def __parse_args_convert(parser: ArgumentParser) -> ArgumentParser:
    ...
    def __parse_args():
        ...
        converter_parser = subparser.add_parser("convert")

        train_parser = ApplicationCLI.__parse_args_train(train_parser)
        util_parser = ApplicationCLI.__parse_args_util(util_parser)
        converter_parser = ApplicationCLI.__parse_args_convert(converter_parser)
